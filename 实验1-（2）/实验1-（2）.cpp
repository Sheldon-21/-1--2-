...
BEGIN_MESSAGE_MAP(C实验12App, CWinAppEx)
...
C实验12App::C实验12App() noexcept
{
	...
	SetAppID(_T("实验12.AppID.NoVersion"));
...
void C实验12App::LoadCustomState()
{
}

void C实验12App::SaveCustomState()
{
}
